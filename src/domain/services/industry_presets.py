...
class IndustryPresets:
        ...
        dimensions = {
            "action_intensity": DimensionDefinition(
                ...
                examples=[
                    {
                        "score": 0.9,
                        "description": "Multi-kill, clutch play, or boss defeat",
                    },
                    {
                        "score": 0.3,
                        "description": "Normal gameplay, farming, or exploration",
                    },
                ],
            ...
            "skill_display": DimensionDefinition(
                ...
                examples=[
                    {
                        "score": 0.95,
                        "description": "Frame-perfect execution, impossible shot",
                    },
                    {
                        "score": 0.4,
                        "description": "Standard gameplay with minor skill moments",
                    },
                ],
            ),
    ...
    def education_preset() -> Dict[str, Any]:
        ...
        dimensions = {
            "concept_clarity": DimensionDefinition(
                ...
                examples=[
                    {
                        "score": 0.9,
                        "description": "Crystal clear explanation with examples",
                    },
                    {
                        "score": 0.4,
                        "description": "Basic explanation, somewhat unclear",
                    },
                ],
            ),
        ...
        processing_options = ProcessingOptions(
            ...
            enabled_modalities={"video", "audio", "text"},
            modality_weights={"video": 0.3, "audio": 0.5, "text": 0.2},
    ...
    def sports_preset() -> Dict[str, Any]:
        ...
        dimensions = {
            "play_significance": DimensionDefinition(
                ...
                examples=[
                    {
                        "score": 0.95,
                        "description": "Game-winning play, record-breaking moment",
                    },
        ...
        processing_options = ProcessingOptions(
            ...
            modality_weights={"video": 0.6, "audio": 0.4},
            min_confidence_threshold=0.7,
    ...
    def corporate_preset() -> Dict[str, Any]:
        ...
        processing_options = ProcessingOptions(
            ...
            modality_weights={"audio": 0.6, "text": 0.4},
