...
class UsageTrackingService(BaseDomainService):
    ...
    async def track_batch_processing(
        ...
        billable_minutes = successful_items * (processing_minutes / total_items) if total_items > 0 else 0
    ...
    async def get_usage_summary(
        ...
        # Calculate totals
        total_cost = sum(
            data["total_cost"] for data in usage_by_type.values()
        )
        ...
        return {
            ...
            "top_resources": [
                ...
                for resource, data in top_resources
            ],
    ...
    async def get_usage_trends(
        ...
        return {
            ...
            "trends": [
                ...
                for period, metrics in sorted_buckets
            ]
        }
