...
ResourceType = Literal["clip", "thumbnail", "stream_clips", "streamer_clips", "all_clips"]
    ...
    def verify_access_token(
        ...
        try:
            ...
            if resource_type == "all_clips":
                ...
                if requested_stream_id and claims.get("stream_id") == str(requested_stream_id):
                    return claims
                return None
            
            elif resource_type == "streamer_clips":
                # Can access all clips from a specific streamer
                if requested_stream_fingerprint and claims.get("stream_fingerprint") == requested_stream_fingerprint:
                    return claims
                return None
