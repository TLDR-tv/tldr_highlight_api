"""Stream ingestion factory functions for automatic format detection and processing.

This module provides factory functions for creating appropriate stream processors
...
def create_stream_pipeline(
    ...
    _apply_stream_type_optimizations(config, stream_type)
...
def _apply_stream_type_optimizations(config: IngestionConfig, stream_type: str) -> None:
...
def create_gaming_pipeline(stream_url: str, **kwargs) -> StreamIngestionPipeline:
    ...
    return create_stream_pipeline(stream_url, config_overrides, **kwargs)


def create_educational_pipeline(stream_url: str, **kwargs) -> StreamIngestionPipeline:
...
def create_sports_pipeline(stream_url: str, **kwargs) -> StreamIngestionPipeline:
