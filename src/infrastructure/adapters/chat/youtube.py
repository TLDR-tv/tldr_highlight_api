...
class YouTubeChatAdapter(BaseChatAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Connected to YouTube Live Chat for channel: {self.channel_id}"
            )
            return True
    ...
    async def disconnect(self) -> None:
        ...
        logger.info(
            f"Disconnecting from YouTube Live Chat for channel: {self.channel_id}"
        )
        ...
        logger.info(
            f"Disconnected from YouTube Live Chat for channel: {self.channel_id}"
        )
