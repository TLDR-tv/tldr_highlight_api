...
class HighlightTypeRegistry(Base, TimestampMixin):
    ...
    __table_args__ = (
        UniqueConstraint('organization_id', name='uq_type_registry_org'),
    )
    ...
    types = Column(JSON, nullable=False, default=dict)  # Dict of type_id -> HighlightTypeDefinition
    ...
    # Relationships
    organization = relationship("Organization", back_populates="highlight_type_registry")
