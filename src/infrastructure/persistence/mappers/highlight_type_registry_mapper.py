...
class HighlightTypeRegistryMapper(Mapper[DomainHighlightTypeRegistry, PersistenceHighlightTypeRegistry]):
    """Maps between HighlightTypeRegistry domain entity and persistence model."""
    
    def to_domain(self, model: PersistenceHighlightTypeRegistry) -> DomainHighlightTypeRegistry:
    ...
    def to_persistence(self, entity: DomainHighlightTypeRegistry) -> PersistenceHighlightTypeRegistry:
