...
from src.domain.value_objects.dimension_definition import DimensionDefinition, DimensionType, AggregationMethod
from src.domain.value_objects.timestamp import Timestamp
from src.infrastructure.persistence.models.dimension_set import DimensionSet as PersistenceDimensionSet
    ...
    def to_domain(self, model: PersistenceDimensionSet) -> DomainDimensionSet:
        ...
        for dim_id, dim_data in model.dimensions.items():
            dimension = DimensionDefinition(
                ...
                applicable_modalities=dim_data.get('applicable_modalities', ['video', 'audio', 'text']),
                aggregation_method=AggregationMethod(dim_data.get('aggregation_method', 'max'))
            )
