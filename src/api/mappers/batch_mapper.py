...
class BatchMapper:
    ...
    @staticmethod
    def batch_create_to_domain(
        dto: BatchCreate, user_id: int, batch_name: str
    ) -> Batch:
        ...
        processing_options = BatchMapper._batch_options_to_processing_options(
            dto.options
        )
    ...
    def batch_to_response(entity: Batch, highlight_count: int = 0) -> BatchResponse:
        ...
        if entity.status == BatchStatus.PROCESSING and entity.started_at:
            ...
            if entity.progress_percentage > 0:
                ...
                if (
                    entity.progress_percentage > 10
                ):  # Avoid division by very small numbers
                    total_estimated_minutes = elapsed / (
                        entity.progress_percentage / 100
                    )
    ...
    @staticmethod
    def _batch_options_to_processing_options(
        ...
        modality_weights = {"video": 0.5, "audio": 0.3, "metadata": 0.2}
