...
class WebhookMapper:
    ...
    def to_webhook_response(webhook: Webhook) -> WebhookResponse:
        ...
        return WebhookResponse(
            ...
            updated_at=webhook.updated_at.value if webhook.updated_at else webhook.created_at.value,
    ...
    def to_webhook_list_response(
        ...
        items = [
            WebhookMapper.to_webhook_response(webhook)
