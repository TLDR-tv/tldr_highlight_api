...
class HighlightFactory(factory.Factory):
    ...
    type = "action"
    confidence = factory.LazyAttribute(lambda _: fake.random.uniform(0.7, 1.0))
    ...
    clip_url = factory.LazyAttribute(lambda _: fake.url())
    thumbnail_url = factory.LazyAttribute(lambda _: fake.url())
