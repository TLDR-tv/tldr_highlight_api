...
class TestErrorHandlingMiddleware:
    ...
    async def test_exception_handling_production(self):
        ...
        assert "Test error message" not in content  # Should not expose details in production
    ...
    async def test_exception_handling_development(self):
        ...
        # Check response content
        content = response.body.decode()
        assert "ValueError: Detailed error message" in content  # Should expose details in development
    ...
    async def test_error_response_format(self):
        ...
        with patch("src.api.middleware.error_handling.create_error_response") as mock_create:
